  ...
  const pricingCotent = [
    {
      ...
      price: '199',
      tag: '',
      features: ['30 job posting', '3 featured job', 'Job displayed for 15 days', 'Premium Support 24/7'],
    },
    {
      id: 2,
      ...
      price: '499',
      tag: 'tagged',
      features: ['40 job posting', '5 featured job', 'Job displayed for 20 days', 'Premium Support 24/7'],
    },
    {
      id: 3,
      ...
      price: '799',
      tag: '',
      features: ['50 job posting', '10 featured job', 'Job displayed for 60 days', 'Premium Support 24/7'],
    },
  ];
  return (
        ...
        <div className="pricing-tabs tabs-box wow fadeInUp">
          ...
          <div className="row">
            {pricingCotent.map((item) => (
              <div className={`pricing-table col-lg-4 col-md-6 col-sm-12 ${item.tag}`} key={item.id}>
